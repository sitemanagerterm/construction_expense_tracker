    ...
    <div className="min-h-screen w-full bg-white flex flex-col items-center justify-center p-6 sm:p-12 lg:p-24 overflow-y-auto">
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-12 sm:mb-16">
          ...
          <div className="w-20 h-20 sm:w-24 sm:h-24 bg-red-50 text-red-600 rounded-[2rem] flex items-center justify-center mb-8 ring-[12px] ring-red-50/50">
        ...
        <div className="border-t border-slate-100 pt-12 sm:pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 max-w-3xl mx-auto">
            {settings?.supportPhone && (
              <div className="flex items-center gap-5 bg-slate-50 p-6 rounded-3xl border border-slate-100 transition-transform hover:-translate-y-1 hover:shadow-sm">
                ...
                <div className="overflow-hidden">
                  ...
                  <p className="text-lg sm:text-xl font-black text-slate-900 truncate">{settings.supportPhone}</p>
                </div>
              </div>
            )}
            ...
            {settings?.supportEmail && (
              <div className="flex items-center gap-5 bg-slate-50 p-6 rounded-3xl border border-slate-100 transition-transform hover:-translate-y-1 hover:shadow-sm">
                ...
                <div className="overflow-hidden">
                  ...
                  <p className="text-lg sm:text-xl font-black text-slate-900 truncate">{settings.supportEmail}</p>
                </div>
              </div>
            )}
          </div>
